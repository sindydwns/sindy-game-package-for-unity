...
{
    /// <summary>
    /// 카운트다운 타이머 모델. PropModel&lt;string&gt;을 상속하므로
    /// TextFeature 생성자에 직접 주입할 수 있습니다: <c>new TextFeature(new TimerModel(60f))</c>
    ...
    /// PropModel&lt;string&gt;을 상속하므로 TextFeature 생성자에 직접 주입할 수 있습니다.
    /// </summary>
