...
```bash
# 기본 (프로젝트 루트에서 실행)
bash Assets/sindy-game-package-for-unity/Tests/Editor/Tools/batch_run.sh "BatchTest.Ping"

# 타임아웃 지정 (초, 기본 120)
bash Assets/sindy-game-package-for-unity/Tests/Editor/Tools/batch_run.sh "SetupShowcaseTask.Run" 180
```
...
| 상황 | 명령 |
|------|------|
| Unity 에디터 열려 있음 | `bash Assets/sindy-game-package-for-unity/Tests/Editor/Tools/sindy_cmd.sh "Namespace.Class.Method"` |
| Unity 에디터 닫혀 있음 | `bash Assets/sindy-game-package-for-unity/Tests/Editor/Tools/batch_run.sh "Class.Method"` |
...
실행:
```bash
bash Assets/sindy-game-package-for-unity/Tests/Editor/Tools/sindy_cmd.sh "Sindy.Editor.Examples.MyNewTask.Execute"
```
...
└── Assets/sindy-game-package-for-unity/
    ├── Editor/
    ...
    └── Tests/Editor/Tools/
        ...
        └── EDITOR_TOOLKIT_GUIDE.md    ← 사용자 가이드
```
